...
def args_parser():
    ...
    parser.add_argument('--freq_sparse', type=bool, default=False, help='ps sparse based on difference freq')
    parser.add_argument('--sparsity_window', type=int, default=100, help='largest grad entry is chosen within this window')
    parser.add_argument('--time_sparse', type=int, default=1000, help='include layer-wise sparsification')
